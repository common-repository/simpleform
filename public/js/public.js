/**
 * JavaScript code delegated to the ajax frontend functionality of the plugin.
 *
 * @package SimpleForm
									...
									if ( error === true ) {
										$.each(
											...
											function ( field, label ) {
												...
												if ( $( 'form#form-' + form ).hasClass( 'needs-focus' ) ) {
													var input    = $( 'input.is-invalid, textarea.is-invalid' ).first();
