...
Tags: contact form, contact form plugin, form builder, forms, smtp
...
For complete information, please visit the [SimpleForm website]().
...
The standard fields that come with SimpleForm are a name field, a last name field, an email address field, a phone number field, a website field, a subject field, a message field and a consent checkbox field.
...
= 2.2.0 =
SimpleForm has undergone significant changes. For the plugin to work properly, you need to clear your website cache and check your previously saved preferences before using the latest version.

== SimpleForm Demo ==

Find out how SimpleForm works, try our [Demo]().
